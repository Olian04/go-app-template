...
// Package version exposes release and build metadata for CLI output and ldflags injection.
package version
...
// LDFLAGS: set via -X [[.ModulePath]]/cmd/[[.CliName]]/version.<Var>=<value> at link time.
var (
	Version   = "unknown"
	Revision  = "unknown"
	BuildTime = "unknown"
...
// Info returns version metadata for display.
